                    ...
                    <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                        ...
                        <div class="pt-0">
                            <form method="POST" action="<?php echo e(route('login')); ?>" class="my-4">
                                ...
                                <div class="form-group d-flex mb-3">
                                    ...
                                    <div class="col-sm-6 text-end">
                                        <a class='text-muted fs-14' href='<?php echo e(route('second', [ 'auth' , 'recoverpw'])); ?>'>Forgot password?</a>
                                    </div>
                                </div>
                            ...
                            <div class="text-center text-muted mb-4">
                                <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='<?php echo e(route('second', [ 'auth' , 'register'])); ?>'>Sing up</a></p>
                            </div>
